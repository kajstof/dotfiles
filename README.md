...
```cmd
choco install 7zip autohotkey bat caliber cmder cpu-z deno dexpot fzf git golang less monitorswitcher mpv msiafterburner neovim nodejs powertoys python ripgrep vifm vim -y
```
